...
export enum HTTPMethod { ALL, GET, POST, PATCH, PUT, DELETE }
export type ExpressMiddleware = { method: HTTPMethod, uri: string, middelware: RequestHandler }
...
export class ApiManager {
	...
	public constructor();
	public constructor(cors_config: CorsOptions);
	public constructor(cors_config: CorsOptions, middlewares: Array<ExpressMiddleware>)
	public constructor(cors_config: CorsOptions = {}, middlewares: Array<ExpressMiddleware> = []) {
		this.app = express();
